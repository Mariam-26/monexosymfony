 ...
 */
class getAteliersRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AteliersRepository' shared autowired service.
     *
     * @return \App\Repository\AteliersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AteliersRepository.php';

        return $container->privates['App\\Repository\\AteliersRepository'] = new \App\Repository\AteliersRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
